...
result = load("../csv_files/valid_csv/life_expectancy_years.csv")
print(result)
...
result = load("../csv_files/invalid_csv/invalid_format.txt")
print(result)
if result is None:
...
result = load("../csv_files/invalid_csv/nonexistent.csv")
print(result)
if result is None:
...
result = load("../csv_files/invalid_csv/empty.csv")
print(result)
if result is None:
...
result = load("../csv_files/invalid_csv/parser_error.csv")
print(result)
if result is None:
...
result = load("../csv_files/invalid_csv/permission_error.csv")
print(result)
if result is None:
