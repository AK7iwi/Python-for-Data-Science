...
ft_filter:
Exception are not handled because built-in fct filter don't do it and cant do it.(too complex)
List fct conversion can failed but in the filterstring we know whats is passing to list
